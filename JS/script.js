...
//(Creare un array con i prodotti)
...
products.forEach( (product, i) => {
    ...
    productCard.classList.add('shop-card', `card-${i}`);
    ...
    productCard.addEventListener( 'click', () =>{
        ...
        descriptionProduct.innerHTML = `
            ...
            <div class="d-flex">
                <span class="product-price">Prezzo: ${product.price}$</span>
                <div class="actions d-flex flex-grow-1 justify-content-end"></div>
            </div>`;
        const actions = document.querySelector('.actions');
        const whishListBtn = document.createElement('button');
        whishListBtn.classList.add('whish-list', 'btn', 'btn-warning', 'me-2')
        whishListBtn.id = 'wishlist';
        whishListBtn.append('Cuore');
        actions.append(whishListBtn);
        
        const cartBtn = document.createElement('button');
        cartBtn.classList.add('add-chart', 'btn', 'btn-warning');
        cartBtn.id = 'chart'
...
const card2 = document.querySelector('.shop-card.card-1 > .card-image')
    card2.classList.add('bg-black');
const card5 = document.querySelector('.shop-card.card-4 > .card-image')
    card5.classList.add('bg-grey');
